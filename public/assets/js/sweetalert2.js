!(function (e, t) {
  ...
  const g = () => document.body.querySelector(".".concat(m.container)),
    ...
    d = () => W(".".concat(m.actions, " .").concat(m.deny));
  const b = () => W(".".concat(m.loader)),
    v = () => W(".".concat(m.actions, " .").concat(m.cancel)),
    $ = () => t(m.actions),
    J = () => t(m.footer),
    G = () => t(m["timer-progress-bar"]),
    Q = () => t(m.close),
    ee = () => {
      var e = Array.from(
          h().querySelectorAll(
  ...
  const Se = [
    ...
    He = (e, t, n) => {
      ...
      n.inputLabel &&
        ...
        (o.className = i),
        "object" == typeof n.customClass && C(o, n.customClass.inputLabel),
        (o.innerText = n.inputLabel),
        t.insertAdjacentElement("beforebegin", o));
    },
    Ie = (e) => k(h(), m[e] || m.input),
    De = (e, t) => {
    ...
    Ve = (e, t) => {
      var n = J();
      le(n, t.footer), t.footer && ke(t.footer, n), w(n, t, "footer");
    },
    Ne = (e, t) => {
      ...
      e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(o).indexOf(t.icon)
          ? (l(
            ...
            P(n))
          : (B(n), ze(n, t), Re(n, t), C(n, t.showClass.icon))
        : P(n);
    },
    Re = (e, t) => {
      for (const n in o) t.icon !== n && A(e, o[n]);
      C(e, o[t.icon]), Ke(e, t), Fe(), w(e, t, "icon");
    },
    Fe = () => {
      var e = h(),
    ...
    Ze = (e, t) => {
      ...
      o.toast)
        ? (C([document.documentElement, document.body], m["toast-shown"]),
          C(n, m.toast))
        : C(n, m.modal);
      w(n, o, "popup"), "string" == typeof o.customClass && C(n, o.customClass);
      o.icon && C(n, m["icon-".concat(o.icon)]);
    },
    Xe = (e, n) => {
      const o = Z();
      ...
      B(o),
        ...
        n.progressSteps.forEach((e, t) => {
          var e = ((e) => {
            ...
            return C(t, m["progress-step"]), y(t, e), t;
          })(e);
          o.appendChild(e),
  ...
  function gt(e) {
    ...
    var t = rt.swalPromiseResolve.get(this),
      n = ((e) => {
        const t = h();
        if (!t) return false;
  ...
  const c = {
    ...
    xt = (e) => {
      ...
      for (const n in e)
        (t = n),
          kt(t) || r('Unknown parameter "'.concat(t, '"')),
          e.toast &&
            ((t = n),
            At.includes(t) &&
  ...
  e = Object.freeze({
    ...
    getInput: function (e) {
      ...
      return (e = p.domCache.get(e || this)) ? re(e.popup, t.input) : null;
    },
    close: gt,
    ...
    rejectPromise: function (e) {
      var t = rt.swalPromiseReject.get(this);
      ht(this), t && t(e);
    },
      ...
      if (n.input) {
        ...
        if (n.inputValidator) {
          ...
          c.then((e) => {
            i.enableButtons(),
              i.enableInput(),
              e ? i.showValidationMessage(e) : ("deny" === a ? It : Vt)(i, r);
          });
        } else
    ...
    en = (e) => {
      ...
      return (
        Array.from(e.querySelectorAll("swal-param")).forEach((e) => {
          ...
          "boolean" == typeof c[t] && "false" === e && (n[t] = !1),
  ...
  const hn = (l, u, d) =>
      new Promise((e, t) => {
        ...
        var o, i, r;
        rt.swalPromiseResolve.set(l, e),
          rt.swalPromiseReject.set(l, t),
          ...
          (t = u),
          (r = n),
          (p.innerParams.get(e).toast ? Nt : (Ft(t), Ut(t), Wt))(e, t, r),
          (o = l),
          (e = E),
          (t = d),
          (i = n),
              ...
              (S(f()), St(r, t));
        {
          ...
          "function" == typeof a.willOpen && a.willOpen(c),
            ...
            te() && (dn(s, a.scrollbarPadding, e), at()),
            ne() ||
    ...
    fn = (e, t) => {
      var n = (n =
          ...
          ? ((n = n.content),
            sn(n),
            Object.assign(en(n), tn(n), nn(n), on(n), rn(n), an(n, Qt)))
          : {},
