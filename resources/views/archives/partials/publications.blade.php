    ...
    <tbody>
        @foreach ($archives as $i => $archive)
            <tr>
                ...
                <td class="text-center">{{ $archive->description }}</td>
                <td class="text-center">
                    <button class="btn btn-sm btn-flash-border-primary bg-danger text-white" onclick="setPageID({{ $archive->id }} )" data-mdb-toggle="modal" data-mdb-target="#page_unarchive">
